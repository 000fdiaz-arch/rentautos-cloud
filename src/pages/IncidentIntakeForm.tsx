...
const EMPTY_FORM: IntakeForm = {
  ...
  insurer: "", hasClaimNumber: "", claimNumber: "", amount: ""
};
    ...
    try {
      if (destination === "judicial") {
        ...
        const collisionCase: CollisionCaseRecord = {
          ...
          status: "PENDIENTE", trialDateHistory: [], judicialFollowUps: [], clientWillAttend: null, legalAssistanceRequested: null, attendanceConfirmedAt: null, incidentPhotos: uploadedJudicialPhotos.filter((photo) => photo.path !== ticketStubPhoto?.path), judicialOutcomeEvidence: null, judicialResolutionEvidence: null, insuranceClaim: null, expenseInvoice: null,
