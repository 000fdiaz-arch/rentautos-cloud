          ...
          <>
            <section className="daily-exec-board">
              <div className="collection-dashboard-cuts">
                {([
                  { key: "am", title: "RUN 1", meta: "Bloque inicial: cartera pendiente y trazabilidad del contacto.", stats: collectionDashboard.am },
                  { key: "pm", title: "RUN 2", meta: "Bloque seguimiento: continuidad de casos heredados.", stats: collectionDashboard.pm },
                  { key: "close", title: "RUN 3", meta: "Bloque cierre: resolución final y envío a calle.", stats: collectionDashboard.close }
                ] as const).map((cut) => (
                  <article key={cut.key} className="collection-dashboard-cut-card">
                    ...
                    <span className="badge badge-good" style={{ alignSelf: "flex-start", marginTop: 6 }}>META</span>
                    ...
                    <div className={`collection-dashboard-kpis ${cut.key === "close" ? "collection-dashboard-kpis--close" : ""}`}>
                      ...
                      {cut.key === "close" && (
                        <div className="collection-dashboard-street-group">
                          <p className="collection-dashboard-street-group__title">Gestión de campo</p>
                          <button
                            type="button"
