export type AppPage = "clients" | "leads" | "payments" | "receivables" | "insurance_claims" | "control_units" | "settings";
...
export default function AppNavigation({
  ...
  const tabs: Array<{ page: AppPage; label: string; mobileLabel: string; visible: boolean }> = [
    ...
    { page: "insurance_claims", label: "Reclamos seguros", mobileLabel: "Seguros", visible: canViewReceivables },
