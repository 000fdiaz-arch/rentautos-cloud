...
(function run() {
  ...
  let c1 = makeClient({ installmentsPaid: 7 });
  ...
  // Caso 4: con mas de 7 cuotas pagadas, domingo se bloquea aunque chargeFirstSunday=true
  let c2 = makeClient({ installmentsPaid: 8 });
